...
{
    public partial class ImpresionBoletaEspecial : System.Web.UI.Page
    {
        ...
        protected void ReportViewer1_SubreportProcessing(object sender, SubreportProcessingEventArgs e)
        {
            ...
            int idBoleta = Convert.ToInt32(Session["IdBoletaEspecial"]);
        ...
        protected void imgImprimir_Click(object sender, ImageClickEventArgs e)
        {
            ...
            FileStream fs = new FileStream(Server.MapPath("~/App_Data/") + Session["IdBoletaEspecial"].ToString()
                            + DateTime.Now.Year + DateTime.Now.Month + DateTime.Now.Day + ".pdf", FileMode.Create);
            fs.Write(bytes, 0, bytes.Length);
            fs.Close();

            string fullpath = System.IO.Path.GetFullPath(Server.MapPath("~/App_Data/") + Session["IdBoletaEspecial"].ToString()
