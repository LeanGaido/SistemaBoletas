    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            ViewBag.StatusMessage =
                message == ManageMessageId.successfulDataModification ? "Los Datos de la Empresa se Modificarion Correctamente"
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> ChangeEmail(string newEmail, string confirmNewEmail)
        {
            if(newEmail == confirmNewEmail)
            {
                if (UserManager.FindByEmail(newEmail) == null)
                {
                    ...
                    var emailBody = "Hola!<br /> Para confirmar el correo, haga clic <a href=\"" + callbackUrl + "\">aquí</a>";
                    ...
                    //Send email  
                    WebMail.Send(to: user.Email, subject: "Confirmar Email", body: emailBody, isBodyHtml: true);
                ...
                {
                    ModelState.AddModelError("newEmail", "El Correo ya esta relacionado a otra Cuenta");
                }
            }
            else
            {
                ModelState.AddModelError("confirmNewEmail", "Los Correos No Coinciden");
            }
